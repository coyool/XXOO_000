...
void SystemInit (void) {
  ...
  FM3_CRG->SCM_CTL   =0;                           /*Clear  Master Clock switch*/
  ...
  FM3_CRG->CSV_CTL  &=0xFFFC;                      /* close Sub/Main CSV */
  ...
  if (SCM_CTL_Val & (1UL << 1)) {                    /* Main clock oscillator enabled ? */
    ...
    FM3_CRG->CSV_CTL |=0X0001;                     /* open Main CSV */
  }
  ...
  if (SCM_CTL_Val & (1UL << 3)) {                    /* Sub clock oscillator enabled ? */
    ...
    FM3_CRG->CSV_CTL |=0x00002;                    /* open Sub CSV */ 
  }
