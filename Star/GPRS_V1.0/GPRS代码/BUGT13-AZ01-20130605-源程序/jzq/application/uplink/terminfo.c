...
static const unsigned char VersionInfo[VERSIONINFO_LEN] = {
	'G', 'W', 'D', 'J',	//厂商代码(4)
	'D', 'J', 'G', 'Z', '2', '2', 0, 0,	//设备编号(8)
	'0'+VERSION_MAJOR, '0'+VERSION_MINOR/10, '0'+VERSION_MINOR%10, '0'+VERSION_PROJECT,	//软件版本(4)
	0, 0, 0,	//软件发布日期：日月年(3)
	'6', '4', 'K', '/', '0', '8', 'M', '/', CHAR_DEBUGINFO, 0, 0,	//配置容量信息码(11)
	'3', '7', '6', '1',	//通信协议.版本号(4)
	'0', '0', '0', '1',	//硬件版本号(4)
	0x20, 0x11,0x11//硬件发布日期(3)
};
